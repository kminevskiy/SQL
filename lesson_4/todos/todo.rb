...
post "/lists/:id" do
  ...
  if error
    ...
    @storage.update_list_name(@list, new_name)
...
post "/lists/:list_id/todos" do
  ...
  if error
    ...
    @storage.add_new_todo(@list, text)
...
post "/lists/:list_id/todos/:id/destroy" do
  ...
  @storage.delete_todo(todo_id, @list)
  if env["HTTP_X_REQUESTED_WITH"] == "XMLHttpRequest"
    status 204
  else
...
post "/lists/:list_id/todos/:id" do
  ...
  @storage.update_todo_status(todo_id, @list, is_completed)
